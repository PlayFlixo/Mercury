const http = require('http'),
    ...
    app = (req, res) => {
      ...
      if (req.query.url && (req.pathname == '/mercury' || req.pathname == '/mercury/' || req.pathname == '/session' || req.pathname == '/session/')) {
    ...
    server = config.ssl ? https.createServer({key: fs.readFileSync('./ssl/default.key'), cert: fs.readFileSync('./ssl/default.cert')}, app) : http.createServer(app);
